...
import { TYPE as type, DESIGNATION as designation, LEAD_SOURCE as leadSource, BUDGET_RANGE as budgetRange, REGION as region, ROLETYPE as roleType } from '@/app/constants/constants'
...
function AddLeadDetailedDialog({ children }: { children: any }) {
    const [selectBoxesState, setSelectBoxesState] = React.useState<SelectBoxState>(selectBoxState)

    function onSelectBoxStateChange(key: keyof SelectBoxState, value: boolean | string) {
        setSelectBoxesState((prevState: SelectBoxState) => {
                ...
                <DialogContent className="p-0 ">
                    ...
                    <div className='flex flex-row gap-6 px-[24px] py[24px] w-[800px]'>
                        <div className='left flex flex-col w-1/2'>
                            ...
                            <Input type="text" className='mt-3 ' placeholder="Enter organisation name" />
                            <div className='mt-3 text-sm text-blue-600 flex flex-row gap-2 justify-end items-center font-medium cursor-pointer'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path d="M4 12L12 4M12 4H6.66667M12 4V9.33333" stroke="#1570EF" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                            ...
                            <div className='flex flex-col mt-3 w-full'>
                                <Popover open={selectBoxesState.region.open} onOpenChange={(e) => onSelectBoxStateChange("region", e)}>
                                    <PopoverTrigger asChild>
                                        <Button
                                            variant="outline"
                                            role="combobox"
                                            aria-expanded={selectBoxesState.region.open}
                                            className=" justify-between"
                                        >
                                            {selectBoxesState.region.value
                                                ? region.find((region) => {
                                                    return region.value === selectBoxesState.region.value
                                                })?.label
                                                : "Select Region"}
                                                ...
                                                {region.map((region) => (
                                                    <CommandItem
                                                        ...
                                                        onSelect={(currentValue) => {
                                                            onSelectBoxStateChange("region", currentValue)
                                                            onSelectBoxStateChange("region", false)
                                                        }}
                                                    >
                                                        {/* <Check
                                                            className={cn(
                            ...
                            <div className='flex flex-col mt-3 w-full'>
                                <Popover open={selectBoxesState.roleType.open} onOpenChange={(e) => onSelectBoxStateChange('roleType', e)}>
                                    <PopoverTrigger asChild>
                                        <Button
                                            variant="outline"
                                            role="combobox"
                                            aria-expanded={selectBoxesState.roleType.open}
                                            className=" justify-between"
                                        >
                                            {selectBoxesState.roleType.value
                                                ? roleType.find((roleType) => roleType.value === selectBoxesState.roleType.value)?.label
                                                : "Select Role Type"}
                                            <ChevronDownIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                        </Button>
                                    </PopoverTrigger>
                                            ...
                                            <CommandGroup>
                                                {roleType.map((roleType) => (
                                                    <CommandItem
                                                        key={roleType.value}
                                                        onSelect={(currentValue) => {
                                                            onSelectBoxStateChange("roleType", roleType.value)
                                                            onSelectBoxStateChange("roleType", false)
                                                        }}
                                                    >
                                                        {/* <Check
                                                            className={cn(
                            ...
                            <div className='flex flex-col mt-3 w-full'>
                                <Popover open={selectBoxesState.budgetRange.open} onOpenChange={(e) => onSelectBoxStateChange('budgetRange', e)}>
                                    <PopoverTrigger asChild>
                                        <Button
                                            variant="outline"
                                            role="combobox"
                                            aria-expanded={selectBoxesState.budgetRange.open}
                                            className=" justify-between"
                                        >
                                            {selectBoxesState.budgetRange.value
                                                ? budgetRange.find((budgetRange) => budgetRange.value === selectBoxesState.budgetRange.value)?.label
                                                : "Select Budget Range"}
                                            <ChevronDownIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                        </Button>
                                    </PopoverTrigger>
                                            ...
                                            <CommandGroup>
                                                {budgetRange.map((budgetRange) => (
                                                    <CommandItem
                                                        ...
                                                        onSelect={(currentValue) => {
                                                            onSelectBoxStateChange("budgetRange", budgetRange.value)
                                                            onSelectBoxStateChange("budgetRange", false)
                                                        }}
                                                    >
                                                        {/* <Check
                                                            className={cn(
                            ...
                            <div className='flex flex-col mt-3 w-full'>
                                <Popover open={selectBoxesState.leadsSource.open} onOpenChange={(e) => onSelectBoxStateChange("leadsSource", e)}>
                                    <PopoverTrigger asChild>
                                        <Button
                                            variant="outline"
                                            role="combobox"
                                            aria-expanesded={selectBoxState.leadsSource.open}
                                            className=" justify-between"
                                        >
                                            {selectBoxesState.leadsSource.value
                                                ? leadSource.find((leadSource) => leadSource.value === selectBoxesState.leadsSource.value)?.label
                                        ...
                                        <Command>
                                            ...
                                            <CommandGroup>
                                                {leadSource.map((leadSource) => (
                                                    <CommandItem
                                                        key={leadSource.value}
                                                        onSelect={(currentValue) => {
                                                            onSelectBoxStateChange("leadsSource", leadSource.value)
                                                            onSelectBoxStateChange("leadsSource", false)
                                                        }}
                                                    >
                                                        {/* <Check
                                                            className={cn(
                                                                "mr-2 h-4 w-4",
                                                                value === leadSource.value ? "opacity-100" : "opacity-0"
                                                            )}
                                                        /> */}
                                                        {leadSource.label}
                                                    </CommandItem>
                        ...
                        <form className='right flex flex-col w-1/2'>
                            <div className="flex flex-row gap-[10px] items-center">
                                <div className="h-[20px] w-[20px] text-gray-500 rounded flex flex-row justify-center">
                                ...
                                <div className='text-sm text-purple-700 cursor-pointer'>+ Add</div>
                            </div>
                            <Input type="text" className='mt-3 ' placeholder="Enter contact name" />
                            <div className='flex flex-row gap-4 mt-3'>
                                <div className='flex flex-col  w-full'>
                                    <Popover open={selectBoxesState.designation.open} onOpenChange={(e) => onSelectBoxStateChange("designation", e)}>
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                                role="combobox"
                                                aria-expanesded={selectBoxState.designation.open}
                                                className=" justify-between"
                                            >
                                                {selectBoxesState.designation.value
                                                    ? designation.find((designation) => designation.value === selectBoxesState.designation.value)?.label
                                                    : "Designation"}
                                                <ChevronDownIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                            </Button>
                                        </PopoverTrigger>
                                                ...
                                                <CommandGroup>
                                                    {designation.map((designation) => (
                                                        <CommandItem
                                                            ...
                                                            onSelect={(currentValue) => {
                                                                onSelectBoxStateChange("designation", designation.value)
                                                                onSelectBoxStateChange("designation", false)
                                                            }}
                                                        >
                                                            {/* <Check
                                                            className={cn(
                                ...
                                <div className='flex flex-col w-full'>
                                    <Popover open={selectBoxesState.type.open} onOpenChange={(e) => onSelectBoxStateChange("type", e)}>
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                                role="combobox"
                                                aria-expanesded={selectBoxState.type.open}
                                                className=" justify-between"
                                            >
                                                {selectBoxesState.type.value
                                                    ? type.find((type) => type.value === selectBoxesState.type.value)?.label
                                                    : "Type (optional)"}
                                                <ChevronDownIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                            </Button>
                                        </PopoverTrigger>
                                                ...
                                                <CommandGroup>
                                                    {type.map((type) => (
                                                        <CommandItem
                                                            key={type.value}
                                                            onSelect={(currentValue) => {
                                                                onSelectBoxStateChange("type", type.value)
                                                                onSelectBoxStateChange("type", false)
                                                            }}
                                                        >
                                                            {/* <Check
                                                            className={cn(
                            ...
                            <Input type="text" className='mt-3 ' placeholder="Phone No" />
