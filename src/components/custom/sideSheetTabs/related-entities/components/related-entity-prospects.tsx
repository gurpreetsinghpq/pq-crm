...
import { columnsProspectsRealtedEntities } from './columns-prospects-related-entities'
...
function RelatedEntityProspects({ data }: { data: ProspectsGetResponse[] }) {
...
export default RelatedEntityProspects