                    ...
                    details.typeOfEntity === "changelog" && <div className=''>
                        <div className='flex flex-col gap-[16px]'>
                            <div className='flex flex-row text-sm font-normal items-center gap-[5px]'>
                                ...
                                {!(details.field_name === "is_created" || details.field_name === "is_converted_to_prospect" || details.field_name === "is_converted_to_deal" || details.field_name === "shipping_address" || details.field_name==="billing_address") && <div className='font-semibold flex flex-row gap-[5px] items-center'>
                                    :
                                    <div className='flex flex-row'>
