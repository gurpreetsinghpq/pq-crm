...
function Settings({ usersForm, teamsForm, profilesForm, permissions }: {
    ...
    return (
        <div className='flex flex-row relative'>
            <div className='flex flex-col min-w-[250px] gap-[16px] h-[100vh]  top-0 left-0 bottom-0 z-[999] px-[16px] py-[36px] bg-gray-50 border-[1px] border-gray-200'>
                ...
                <div className='flex flex-col gap-[4px] cursor-pointer rounded-[6px]'>
                    ...
                    <div className='relative flex flex-col gap-[12px] text-sm font-semibold'>
                        ...
                        <div className='flex flex-col border-l-[2px] border-gray-300 mx-[12px] gap-[8px]'>
