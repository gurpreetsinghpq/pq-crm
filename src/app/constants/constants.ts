...
const ROLETYPE: IValueLabel[] = [
    ...
    {
        value: "vp_of_ds",
        label: "VP of Data Science",
        acronym: "VPODS"
    },
    {
        value: "director_of_ds",
...
const CONTACT_TYPE: IValueLabel[] = TYPE.filter((type)=>type.value!="accountsPayable")
...
const ACTIVITY_TYPE_ACCOUNTS: IValueLabel[] = [
    {
        value: "coldOutreach",
        label: "Cold Outreach"
    }
...
const LEAD_PROSPECT_STATUS: IValueLabel[] = [
    ...STATUSES,
    ...PROSPECT_STATUSES
]
...
const DUPLICATE_ERROR_MESSAGE_DEFAULT = {
    email: false,
    phone: false
}
const DATE_DROPDOWN_CUMMULATIVE: DropdownOption[] = [
